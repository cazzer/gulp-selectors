...
module.exports = {
	 ...
	 */
	//TODO rewrite these selectors to capture a valid trailing character instead of an invalid one
	classSelector: new RegExp('(?<!url\().*(\\.{1})' + selectorName + '(\\s*\\)*)', 'g'),
	idSelector: new RegExp('(#{1})' + selectorName + '(\\s*;*}*)', 'g'),
	/**
